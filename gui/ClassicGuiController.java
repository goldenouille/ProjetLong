...
public class ClassicGuiController implements GuiController {
	...
	public ClassicGuiController(Object core) {
		...
		// test
		doAddText(false, "Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro.Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. Un compte simple est caracterise par un solde exprime en euro. ".split(" "));
	...
	public void doShowUmlInstanceCreationPopup(int firstWord, int lastWord, Object nature) throws BadLocationException {
		...
		if (nature.equals(UMLNature.CLASS)) {
			ClassEditionPanel classPanel = new ClassEditionPanel(this, firstWord, lastWord, null);
			int result = JOptionPane.showConfirmDialog(null, classPanel, "Nouvelle classe",
	...
	public void doShowUmlInstanceEditionPopup(int firstWord, int lastWord, boolean userText, Object nature)
		...
		if (nature.equals(UMLNature.CLASS)) {
			...
			ClassEditionPanel classPanel = new ClassEditionPanel(this, firstWord, lastWord, name);
			int result = JOptionPane.showConfirmDialog(null, classPanel, "Nouvelle classe",
					JOptionPane.OK_CANCEL_OPTION);
			if (result == JOptionPane.OK_OPTION) {
	...
	public void doShowTextAdditionPopup() {
		...
		int result = JOptionPane.showConfirmDialog(null, textPanel, "Ajout de texte",
				JOptionPane.OK_CANCEL_OPTION);
		if (result == JOptionPane.OK_OPTION) {
